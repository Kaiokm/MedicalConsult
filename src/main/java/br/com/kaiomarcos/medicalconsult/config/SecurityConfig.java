package br.com.kaiomarcos.medicalconsult.config;
...
public class SecurityConfig {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("KAIO").password(passwordEncoder.encode("12345")).roles("ADMIN")
                .and()
                .withUser("BERNARDO").password(passwordEncoder.encode("54321")).roles("PACIENTE")
                .and()
                .withUser("CLEIA").password(passwordEncoder.encode("333")).roles("SECRETARIA");
